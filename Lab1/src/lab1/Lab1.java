...
public class Lab1 extends javax.swing.JFrame
{
  ...
  protected EventListener makeCanvasListener(ScribbleCanvas canvas) {
    ...
    protected void addToolbarButtons(JToolBar toolBar) {
         ...
         clearb = new JButton(new ImageIcon("src/Lab1/clear.gif"));
         ...
         scribbleb = new JButton(new ImageIcon("src/Lab1/scribble.gif"));
         ...
         lineb = new JButton(new ImageIcon("src/Lab1/line.gif"));
         ...
         rectangleb = new JButton(new ImageIcon("src/Lab1/rectangle.gif"));
         ...
         ovalb = new JButton(new ImageIcon("src/Lab1/oval.gif"));
         ...
         eraseb = new JButton(new ImageIcon("src/Lab1/eraser.gif"));
